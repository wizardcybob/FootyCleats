 ...
 */
final class Version20220317144257 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cleat (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, marque_id INTEGER NOT NULL, terrain_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, prix VARCHAR(255) DEFAULT NULL, image1 VARCHAR(255) NOT NULL, image2 VARCHAR(255) DEFAULT NULL, image3 VARCHAR(255) DEFAULT NULL, image4 VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_CD254334827B9B2 FOREIGN KEY (marque_id) REFERENCES marque (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CD254338A2D8B41 FOREIGN KEY (terrain_id) REFERENCES terrain (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('DROP INDEX IDX_50E052A3F666B55D');
        $this->addSql('DROP INDEX IDX_50E052A3A76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__cleat_user AS SELECT cleat_id, user_id FROM cleat_user');
        $this->addSql('DROP TABLE cleat_user');
        $this->addSql('CREATE TABLE cleat_user (cleat_id INTEGER NOT NULL, user_id INTEGER NOT NULL, PRIMARY KEY(cleat_id, user_id), CONSTRAINT FK_50E052A3F666B55D FOREIGN KEY (cleat_id) REFERENCES cleat (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_50E052A3A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO cleat_user (cleat_id, user_id) SELECT cleat_id, user_id FROM __temp__cleat_user');
        $this->addSql('DROP TABLE __temp__cleat_user');
