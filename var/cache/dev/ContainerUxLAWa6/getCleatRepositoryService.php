 ...
 */
class getCleatRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CleatRepository' shared autowired service.
     *
     * @return \App\Repository\CleatRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CleatRepository.php';

        return $container->privates['App\\Repository\\CleatRepository'] = new \App\Repository\CleatRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
