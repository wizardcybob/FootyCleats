...
class getLoginFormControllerAuthenticatorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'LoginFormControllerAuthenticator.php';

        return $container->privates['App\\Security\\LoginFormControllerAuthenticator'] = new \App\Security\LoginFormControllerAuthenticator(($container->services['router'] ?? $container->getRouterService()));
    }
}
