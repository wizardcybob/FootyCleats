...
class __TwigTemplate_7b930ecc18202a28ffdbedfcc4bdb0476b602e09221c9dc42af35db7e89ba32c extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"update_form_panier\">
    ...
    <button class=\"form_box_btn\">";
        // line 6
        echo twig_escape_filter($this->env, ((array_key_exists("button_label", $context)) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 6, $this->source); })()), "Enregistrer")) : ("Enregistrer")), "html", null, true);
        echo "</button>
";
        // line 7
...
";
    ...
    {
        return array (  58 => 7,  54 => 6,  48 => 3,  43 => 1,);
    }
...
{{ form_end(form) }}
", "panier/_form.html.twig", "C:\\Users\\wizardcybob\\Desktop\\Moi\\Travail\\IUT\\S4\\INFO4\\TEST SYMFONY\\FootyCleats\\templates\\panier\\_form.html.twig");
    }
}
