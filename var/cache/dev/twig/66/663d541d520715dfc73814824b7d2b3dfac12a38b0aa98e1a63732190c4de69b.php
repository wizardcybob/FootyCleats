...
class __TwigTemplate_84e1a917897e32f54335484cde8b71f8ac174a94518b020d46ed9ef4cb3b505a extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"pannel_produits\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["panier"]) {
            ...
            <a href=\"";
            // line 16
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_panier_show", ["id" => twig_get_attribute($this->env, $this->source, $context["panier"], "id", [], "any", false, false, false, 16)]), "html", null, true);
            echo "\">
                <div class=\"pannel_produits_box_img\">
                    <p><b>";
            // line 18
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["panier"], "id", [], "any", false, false, false, 18), "html", null, true);
            echo "</b></p>
                </div>
                <div class=\"pannel_produits_box_info\">
                    <p>Pannier de : <i>";
            // line 21
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["panier"], "pseudo", [], "any", false, false, false, 21), "html", null, true);
            echo "</i></p>
                </div>
            </a>
            <a class=\"pannel_produits_edit\" href=\"";
            // line 24
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_panier_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["panier"], "id", [], "any", false, false, false, 24)]), "html", null, true);
            echo "\">Modifier</a>
            ";
            // line 26
            echo "        </div>
    ...
    public function block_btn_page($context, array $blocks = [])
    {
        ...
        echo "\"><button>Voir les crampons</button></a>
    ";
    ...
    {
        return array (  163 => 9,  153 => 8,  141 => 30,  134 => 28,  128 => 26,  124 => 24,  118 => 21,  112 => 18,  107 => 16,  104 => 15,  98 => 14,  94 => 11,  91 => 8,  81 => 7,  70 => 4,  60 => 3,  37 => 1,);
    }
...
{% block body %}
    {% block btn_page %}
    <a href=\"{{ path('compte') }}\"><button>Voir les crampons</button></a>
    {% endblock %}
    ...
    <div class=\"pannel_produits\">
        ...
        <div class=\"pannel_produits_box\">
            <a href=\"{{ path('app_panier_show', {'id': panier.id}) }}\">
                <div class=\"pannel_produits_box_img\">
                    <p><b>{{ panier.id }}</b></p>
                </div>
                <div class=\"pannel_produits_box_info\">
                    <p>Pannier de : <i>{{ panier.pseudo }}</i></p>
                </div>
            </a>
            <a class=\"pannel_produits_edit\" href=\"{{ path('app_panier_edit', {'id': panier.id}) }}\">Modifier</a>
            {# {{ include('panier/_delete_form.html.twig') }} -> sinon ça delete le panier du user qu'on peut pas recréer il faudrait le vider à la place #}
        </div>
        {% else %}
    ...
    {# <a href=\"{{ path('app_panier_new') }}\"><button>Créer un panier</button></a> #}
{% endblock %}
", "panier/index.html.twig", "C:\\Users\\wizardcybob\\Desktop\\Moi\\Travail\\IUT\\S4\\INFO4\\TEST SYMFONY\\FootyCleats\\templates\\panier\\index.html.twig");
    }
}
